...
public class HomeBannerContainerimpl implements HomeBannerContainer {
    ...
    public HomeBannerContainerimpl(View contentView) {

        ButterKnife.bind(contentView);
        initBannerRecycler(contentView.getContext());

    }
    public void initBannerRecycler(Context context){

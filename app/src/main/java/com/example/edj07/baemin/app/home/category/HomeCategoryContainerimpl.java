...
public class HomeCategoryContainerimpl implements HomeCategoryContainer{

    @BindView(R.id.rv_home_search) RecyclerView rvCategory;
    private HomeCategoryAdapter categoryAdapter;
    @BindDrawable(R.drawable.shape_home_category_divider)
    Drawable categoryDrawableDivider;

    public HomeCategoryContainerimpl(View contentView) {

        ButterKnife.bind(contentView);
        initCategoryRecycler(contentView.getContext());

    }

    public void initCategoryRecycler(Context context){
